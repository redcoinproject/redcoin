...
static const int64 MAX_MONEY = 330000000 * COIN; // Redcoin: maximum of 330M coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // Redcoin: 1440 blocks found a day. Priority cutoff is 1 redcoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("0412345678901234567890000111222333444555666777888999000000aaaaabbbbbcccccdddddeeeeeff00ff00ff00ff001234567890abcdef0022446688abc89")))
